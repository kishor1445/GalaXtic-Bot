...
class Admin(commands.Cog):
    ...
    @app_commands.command(name="add_roles", description="Add multiple roles to the server (admin only)")
    ...
    @commands.command(name="add_roles", help="Add multiple roles to the server (admin only). Usage: !add_roles role1, role2, role3")
