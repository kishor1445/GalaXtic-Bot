...
class Music(Cog):
    ...
    async def play_next_song(self, voice_client, guild_id, channel):
        if SONGS_QUEUE[guild_id]:
            ...
            source = discord.FFmpegOpusAudio(song_data.audio_url, **ffmpeg_options, executable="ffmpeg")
            ...
            embed.add_field(name="", value=f"**Duration**: {song_data.duration}", inline=True)
